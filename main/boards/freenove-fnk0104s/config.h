...
#define EXTERNAL_I2S_OUTPUT_SAMPLE_RATE 48000
...
// Optional external I2S speaker (MAX98357A-compatible)
#define EXTERNAL_I2S_PORT         1
#define EXTERNAL_I2S_BCLK_PIN     GPIO_NUM_2
#define EXTERNAL_I2S_WS_PIN       GPIO_NUM_21
#define EXTERNAL_I2S_DATA_PIN     GPIO_NUM_14

// Buttons & Built-in LED
#define BOOT_BUTTON_GPIO         GPIO_NUM_0
#define BUILTIN_LED_GPIO         GPIO_NUM_42

// Display (ST7796 4.0" IPS 320x480)
...
// SD Card (SDMMC 1-bit mode: official FNK0104S schematic)
